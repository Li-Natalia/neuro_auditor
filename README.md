...
**Платформа для аудита финансовой отчётности  AI-ассистентом:** загрузка Excel-отчётов (*МСФО/РСБУ*), автоматический расчёт коэффициентов и выявление рисков,построение дашбордов и формирование PDF, а также чат-бот по документам на базе *YandexGPT* (`Yandex Cloud Foundation Models`).
